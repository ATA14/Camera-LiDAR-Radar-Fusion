# -*- coding: utf-8 -*-
"""Visual_Fusion_Early.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17wwIWw_gTyNB8TsLWZM2ggArqxnUPWLh
...
os.chdir("/content/drive/My Drive/BP")
!ls
...
"""###Change '.bin' to '.pcd (Note that you will need to delete the '.bin' files or skip them while loading the '.pcd' files)"""

point_files = sorted(glob.glob("lidar/*"))
index = 0
...
import os
from google.colab import drive
drive.mount('/content/drive', force_remount=True) #Re-Mount the drive to use the new pointcloud file format
...
point_files = sorted(glob.glob("lidar/*"))
label_files = sorted(glob.glob("label/*"))
calib_files = sorted(glob.glob("calib/*"))
...
yolo.classes = "/content/coco.txt"
yolo.make_model()
yolo.load_weights("/content/yolov4-tiny (1).weights", weights_type="yolo")
...
def rectContains(rect,pt, w, h, shrink_factor = 0.15):       
